...
These exercises are a series of CSS related tasks intended to complement the HTML and CSS content on AppSy Learning Hub. They should only be done when instructed during the course of the curriculum.
...
5. Once you successfully finish an exercise, check ALH's solution to compare it with yours. 
   * You should not be checking the solution for an exercise until you finish it!
   * Keep in mind that ALH's solution is not the only solution. If your solution differs wildly from ALH's solution (and still passes the self-check criteria), feel free to ask about it in the chatroom.
...
- You may need to add more selectors to your CSS file. The first few exercises have almost everything already done for you, but as you progress you'll find that you need to add more and more to get the correct result.TP
